...
When a worker takes an action — opens a branch, creates a PR, posts a Slack message — it records the link itself. "I opened PR #17 for issue #42." This is the primary mechanism for keeping artifacts connected to their thread.
